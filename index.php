...
<head>
  ...
  <title>Keuangan Cavita Farma</title>
...
<body id="page-top">
  ...
  // Mengambil total pengeluaran hari ini
  $pengeluaran_query = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total_pengeluaran FROM pengeluaran WHERE tgl_pengeluaran = CURDATE()");
  $pengeluaran_hari_ini = mysqli_fetch_assoc($pengeluaran_query);
  $total_pengeluaran_hari_ini = $pengeluaran_hari_ini['total_pengeluaran'];

  // Mengambil total pemasukan hari ini
  $pemasukan_query = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total_pemasukan FROM pemasukan WHERE tgl_pemasukan = CURDATE()");
  $pemasukan_hari_ini = mysqli_fetch_assoc($pemasukan_query);
  $total_pemasukan_hari_ini = $pemasukan_hari_ini['total_pemasukan'];
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?= number_format($total_pemasukan_hari_ini, 2, ',', '.'); ?></div>
                </div>
                <div class="col-auto">
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?= number_format($total_pengeluaran_hari_ini, 2, ',', '.'); ?></div>
                </div>
                <div class="col-auto">
